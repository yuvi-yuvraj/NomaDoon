          ...
          <Col lg='8'>
            <div className="tour__content">
              ...
              <div className='tour__info'>
                ...
                <i className="ri-star-fill" style={{color: "var(--secondary-color)"}}></i>{avgRating === 0 ? null : avgRating} {totalRating === 0 ? ("Not rated") : (<span>({reviews?.length})</span>)} 
                  </span>
                ...
                <div className="tour__extra-details">
                    <span><i className="ri-map-pin-5-line"></i>{city}</span>
                        ...
                        <div className='w-100'>
                          <div className='d-flex align-items-center justify-content-between'>
                            <div>
                              <h5>Yuvi</h5>
                              <p>
                                {new Date("01-11-2026").toLocaleDateString("en-US", options)}
                              </p>
                            </div>
