        ...
        <div className='booking__form'>
            ...
            <Form className='booking__info-form' onSubmit={handleClick}>
                ...
                <FormGroup className='d-flex align-items-center gap-3'>
                    <input type="date" placeholder='Booking Date' id='bookAt' required onClick={handleChange}/>
                    <input type="number" placeholder='Guests' id='guestSize' required onClick={handleChange}/>
                </FormGroup>
            </Form>
        </div>
